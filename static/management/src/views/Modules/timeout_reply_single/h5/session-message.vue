...
import H5MessageRender from "@/views/sessionArchive/components/modules/childs/h5MessageRender.vue";
...
import {h5SessionMessage} from "@/api/h5/timeout-reply-single";
...
function loadData() {
    ...
    h5SessionMessage({
        ...
        chatName.value = chatNameParse(data.from_detail, data.to_detail)
...
function chatNameParse(from_detail, to_detail) {
