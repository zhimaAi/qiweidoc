...
class InitCorpInfoDTO extends BaseDTO implements RulesProviderInterface
{
    ...
    public function getRules(): iterable
    {
        return [
            ...
            'verifyDomainFileContent' => [
                new Required(message: '验证文件的内容不能为空'),
